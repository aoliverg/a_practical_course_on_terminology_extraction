...
This is a simple tagger able to POS tag text files (it is recommended that the text file are segmented). It uses Spacy and the Spacy model es_core_news_sm. The model should be located in the same folder as the program.
